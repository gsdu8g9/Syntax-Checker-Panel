...
public class Syntax implements SyntaxConstants {
...
//Grammer Description //
  ...
  final public void lassign() throws ParseException {
    assign();
    label_3:
    while (true) {
      if (jj_2_27(5)) {
  ...
  final public void expbool() throws ParseException {
    bool();
    label_4:
    while (true) {
      if (jj_2_32(5)) {
  ...
  public SyntaxTokenManager token_source;
